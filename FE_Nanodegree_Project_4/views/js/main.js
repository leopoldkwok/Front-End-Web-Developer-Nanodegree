...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    //Since pizzas length are same declare variables outside loop
...
function updatePositions() {
  ...
  for (var i=0; i<5; i++){
    phaseArray[i] = Math.sin(scrollNumber + i) * 100;
  } // Calcuations that are on on invidivual basis
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Caculating number of pizzas that will be presented
